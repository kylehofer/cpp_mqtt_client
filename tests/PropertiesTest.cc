...
#define CONTENT_TYPE_PROPERTY 3, 0, 0, 0, 0
#define RESPONSE_TOPIC_PROPERTY 8, 0, 0, 0, 0
#define CORRELATION_DATA_PROPERTY 9, 0, 0, 0, 0
#define SUBSCRIPTION_IDENTIFIER_PROPERTY 11, 0
#define SESSION_EXPIRY_INTERVAL_PROPERTY 17, 0, 0, 0, 0
#define ASSIGNED_CLIENT_IDENTIFER_PROPERTY 18, 0, 0, 0, 0
#define SERVER_KEEP_ALIVE_PROPERTY 19, 0, 0
#define AUTHENTICATION_METHOD_PROPERTY 21, 0, 0, 0, 0
#define AUTHENTICATION_DATA_PROPERTY 22, 0, 0, 0, 0
...
#define RESPONSE_INFORMATION_PROPERTY 26, 0, 0, 0, 0
#define SERVER_REFERENCE_PROPERTY 28, 0, 0, 0, 0
#define REASON_STRING_PROPERTY 31, 0, 0, 0, 0
...
#define USER_PROPERTY_PROPERTY 38, 0, 0, 0, 0, 0, 0, 0, 0
